...
public class PoiInfoOverlay extends PoiOverlay {
    ...
    private void showPopView0() {
        TextView tv_pop_loctitle = (TextView) popView.findViewById(R.id.tv_location_title);
        ...
        tv_pop_locinfo.setVisibility(View.GONE);

        if(lbs != null) {
            tv_pop_loctitle.setText(lbs.getAddrStr());
            tv_pop_loctime.setText(CalendarUtil.showSimpleTime(lbs.getCreateTime()));
        } else {
            tv_pop_loctitle.setText("我的位置");
    ...
    private void showPopView1() {
        ...
        if(lbs != null) {
            tv_pop_loctitle.setText("搜 \"" + lbsDoPoiYun.getKeyword() + "\"");
            tv_pop_loctitle.setText("被搜索1次");
            tv_pop_loctime.setText(CalendarUtil.showSimpleTime(new Date(((long)(lbsDoPoiYun.getCreateTime())))));
        } else {
            tv_pop_loctitle.setText("暂无记录");
            tv_pop_loctitle.setText("被搜索1次");
            tv_pop_loctime.setText("暂无记录");
